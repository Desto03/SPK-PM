    ...
    <div class="card-header">
      <div class="col-6">
        <select class="custom-select d-block w-50" id="aspek" name="aspek" required>
          ...
          <option value="kecerdasan" <?php echo $_REQUEST == "kecerdasan" ? "selected=selected" : ""; ?>>Kecerdasan</option>
          <option value="wawancara" <?php echo $_REQUEST == "wawancara" ? "selected=selected" : ""; ?>>Wawancara</option>
          <option value="sikapkerja" <?php echo $_REQUEST == "sikapkerja" ? "selected=selected" : ""; ?>>Sikap Kerja</option>
        </select>
      </div>
    </div>
    <div class="card-body">
